...
def lambda_handler(event, context):
    ...
    if not t:
        if "rightsizing" in str(args).lower(): t = "get_rightsizing_recommendations"
        elif "savings_plan" in str(args).lower() or "savings plan" in str(args).lower(): t = "get_savings_plans_recommendations"
        elif "reserved" in str(args).lower() or "ri_" in str(args).lower(): t = "get_reserved_instance_recommendations"
        elif "optimization_hub" in str(args).lower() or "hub" in str(args).lower(): t = "get_cost_optimization_hub_recommendations"
        elif "trusted" in str(args).lower() or "advisor" in str(args).lower(): t = "get_trusted_advisor_cost_checks"
