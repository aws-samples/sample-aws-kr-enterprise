...
def lambda_handler(event, context):
    ...
    if not t:
        if "ip_address" in args: t = "find_ip_address"
        elif "eni_id" in args: t = "get_eni_details"
        elif "tgw_id" in args and "route_table_id" in args: t = "get_tgw_routes"
        elif "tgw_id" in args: t = "get_tgw_details"
        elif "vpc_id" in args and "flow" in str(args).lower(): t = "get_vpc_flow_logs"
        elif "vpc_id" in args: t = "get_vpc_network_details"
        elif "firewall_name" in args: t = "get_firewall_rules"
        elif "resource_type" in args: t = "describe_network"
