...
def lambda_handler(event, context):
    ...
    if not t:
        if "replication_group_id" in args: t = "describe_replication_group"
        elif "cluster_id" in args: t = "describe_cache_cluster"
        elif "serverless" in str(args).lower(): t = "list_serverless_caches"
