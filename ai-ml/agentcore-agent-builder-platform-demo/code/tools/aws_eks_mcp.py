...
def lambda_handler(event, context):
    ...
    if not t:
        if "cluster_name" in args and "kind" in args:
            t = "list_k8s_resources"
        elif "cluster_name" in args and "pod_name" in args:
            t = "get_pod_logs"
        elif "cluster_name" in args and "log_type" in args:
            t = "get_cloudwatch_logs"
        elif "cluster_name" in args and "metric_name" in args:
            t = "get_cloudwatch_metrics"
        elif "cluster_name" in args and "insight_id" in args:
            t = "get_eks_insights"
        elif "cluster_name" in args:
            t = "get_eks_vpc_config"
        elif "role_name" in args:
