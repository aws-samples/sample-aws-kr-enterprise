...
def lambda_handler(event, context):
    ...
    if not t:
        if "user_name" in args and "policy" in str(args).lower(): t = "list_user_policies"
        elif "user_name" in args: t = "get_user"
        elif "role_name" in args and "policy" in str(args).lower(): t = "list_role_policies"
        elif "role_name" in args: t = "get_role_details"
        elif "group_name" in args: t = "get_group"
        elif "action_names" in args: t = "simulate_principal_policy"
        elif "policy" in str(args).lower(): t = "list_policies"
        elif "role" in str(args).lower(): t = "list_roles"
        elif "group" in str(args).lower(): t = "list_groups"
        else: t = "list_users"
    ...
    try:
        ...
        if t == "list_users":
            ...
            if args.get("marker"): kwargs["Marker"] = args["marker"]
